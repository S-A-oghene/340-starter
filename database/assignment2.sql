...
ALTER TYPE public.account_type OWNER TO course2db;
...
-- Query 2: Modify the Tony Stark record to change account_type to 'Admin'
...
-- Query 4: Modify the "GM Hummer" record to change "small interiors" to "a huge interior" using REPLACE
...
-- Query 5: Select make, model, and classification_name for "Sport" category using an INNER JOIN
SELECT inv_make,
    inv_model,
    classification_name
FROM public.inventory
...
-- Query 6: Update inv_image and inv_thumbnail to add '/vehicles' to the file path
UPDATE public.inventory
